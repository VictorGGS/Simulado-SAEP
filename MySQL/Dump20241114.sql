CREATE DATABASE  IF NOT EXISTS `simuladosaep` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `simuladosaep`;
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: simuladosaep
-- ------------------------------------------------------
...
CREATE TABLE `inscricao` (
  `id` int NOT NULL,
  `id_curso` int NOT NULL,
  `numero_inscricoes` text,
  `tempo_inscricoes` text,
...
INSERT INTO `usuario` VALUES (1,'marianavasco','marivasco@usuario.com','marianavasco',123456,'mari_vasco.jpg','2023-06-22 09:13:55','2023-06-22 09:14:55'),(2,'ramielcunha','ramiel@usuario.com','ramielcunha',654321,'ramiel_cunha.jpg','2023-02-22 09:13:55','2023-02-22 09:13:58'),(3,'billjobs','iwindows@usuario.com','billjobs',87654,'bill_jobs.jpg','2023-08-22 09:13:55','2023-08-22 09:15:55');
...
-- Dump completed on 2024-11-14 21:31:54
